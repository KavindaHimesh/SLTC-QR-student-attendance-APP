...
public class RegistrationActivity extends AppCompatActivity {
    ...
    EditText mFullName,mEmail,mPassword,mPhone,mFaculty,mDegree,mReg;
    Button mRegisterBtn;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFaculty      = findViewById(R.id.uFaculty);
        mDegree      = findViewById(R.id.uDegree);
            mReg      = findViewById(R.id.uReg);
        mPassword   = findViewById(R.id.uPassword);
        mPhone      = findViewById(R.id.uPhn);
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String faculty    = mFaculty.getText().toString();
                final String degree    = mDegree.getText().toString();
                final String regno  = mReg.getText().toString();
